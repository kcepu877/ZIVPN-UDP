...
# --- License Info ---
LICENSE_URL="https://raw.githubusercontent.com/kcepu877/izin/main/ip"
...
function show_expired_message_and_exit() {
    ...
    echo -e "silakan hubungi admin https://wa.me/6281311967169 \n"
...
function show_menu() {
    ...
    echo -e "${YELLOW}╔══════════════════// ${CYAN}ZERO TUNNELING${YELLOW} //═══════════════════╗${NC}"
    _draw_info_panel
...
function run_setup() {
    ...
    wget -O zi.sh https://raw.githubusercontent.com/kcepu877/ZIVPN-UDP/main/zi.sh
    ...
    wget -O /usr/local/bin/zivpn_helper.sh https://raw.githubusercontent.com/kcepu877/ZIVPN-UDP/main/zivpn_helper.sh
    if [ $? -ne 0 ]; then
